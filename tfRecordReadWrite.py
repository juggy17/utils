...
def read_from_tfrecord(filenames):
    ...
    image = tf.decode_raw(tfrecord_features['image'], tf.int32)
...
def main():
    ...
    label = 1 
    image_file = IMAGE_PATH + 'xy39c1z01.tif'
    tfrecord_file = IMAGE_PATH + 'xy39c1z01.tfrecord'
